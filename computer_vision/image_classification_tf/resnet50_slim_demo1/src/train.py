...
from net.resnet import resnet_v1_35_model as model
...
flags.DEFINE_string('label_path',
                    'tfrecord/labels.txt',
                    'Path to label file.')
flags.DEFINE_string('log_dir', './log/train_tf_log', 'Path to log directory.')
...
def main(_):
    ...
    train_mode = FLAGS.train_mode  # train from scratch or finetune on imagenet pretrained model or continue training on previous model
