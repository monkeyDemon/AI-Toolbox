...
def resnet_v1_20(inputs,
                 ...
                 reuse=None,
                 scope='resnet_v1_20'):
  """Customized lightweight ResNet-20 model. See resnet_v1() for arg and return description."""
  blocks = [
...
# add by zyb_as 2019/8/13
def resnet_v1_35(inputs,
                 num_classes=None,
                 is_training=True,
                 global_pool=True,
                 output_stride=None,
                 reuse=None,
                 scope='resnet_v1_35'):
  """Customized lightweight ResNet-35 model. See resnet_v1() for arg and return description."""
  blocks = [
      resnet_v1_block('block1', base_depth=64, num_units=2, stride=2),
      resnet_v1_block('block2', base_depth=128, num_units=3, stride=2),
      resnet_v1_block('block3', base_depth=256, num_units=4, stride=2),
